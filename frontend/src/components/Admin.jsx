...
export default function Admin() {
    ...
    const [grievances] = useState([
        { id: "LNMIIT/2025/04/12345", title: "Water not coming from tap", submittedBy: "22ucc072", status: "Pending", date: "2025-04-06" },
        { id: "LNMIIT/2025/04/12346", title: "Wi-Fi not working in Room 203", submittedBy: "22ucc017", status: "In Progress", date: "2025-04-05" },
    ]);
        ...
        <div className="min-h-screen bg-gradient-to-br from-red-300 to-blue-300 py-12 px-6">
            <div className="max-w-6xl mx-auto bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8">
                ...
                <p className="text-center text-gray-700 mb-8">
                    You can manage all grievances here.
                </p>
                            ...
                            {grievances.map((g) => (
                                <tr key={g.id} className="border-t">
                                    ...
                                    <td className="py-3 px-4">
                                        <span
                                            className={`px-3 py-1 rounded-full text-sm font-medium ${g.status === "Pending"
